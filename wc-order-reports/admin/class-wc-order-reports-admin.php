...
class Wc_Order_Reports_Admin{
	...
	public function __construct( $plugin_name, $version ) {
		...
		add_action( 'wc_order_header', array($this,'start_page_contener'), 10);
		add_action( 'wc_order_header', array($this,'add_page_tabs'), 20);
		add_action( 'wc_order_footer', array($this,'end_page_contener'), 10);
	}
  ...
  protected function is_active_tabs($tab_name=""){
	...
	public function add_page_tabs(){
		...
		<div class="tabs wor-tabs">
			<nav>
				<ul>
					<li class="<?php echo $this->is_active_tabs("wc-order-reports"); ?>"><a href="<?php echo $this->wc_order_url; ?>" class="icon icon-home"><span>Order Overview</span></a></li>
					<li class="<?php echo $this->is_active_tabs('wc-order-reports-download'); ?>"><a href="<?php echo $this->wc_order_url.'-download'; ?>" class="icon icon-download"><span>Download Reports</span></a></li>
				</ul>
			</nav>
		</div>
		<?php
