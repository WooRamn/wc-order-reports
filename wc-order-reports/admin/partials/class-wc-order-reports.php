...
if(!class_exists('WOR_Dashboard')):
	require_once( 'helper/class-wor-dashboard-helper.php');
	class WOR_Dashboard extends WOR_Dashboard_Helper{
    protected $WOR_DB_Helper;
      ...
      $result = $this->WOR_DB_Helper->get_dashboard_data($start_date, $today_date);
      ...
      $today_date = date( 'M-d-Y', strtotime( 'now' ));
			...
			<div class="wor-page-contener wor-report">				
              ...
              <div class="wor-dashboard-sec mt40 wor-dashboard-sec-2" id="wor-dashboard-sec-2">
                <h2 class="wor-section-header__title wor-section-header__header-item icon icon-status">Order status wise performance</h2>
                <hr role="presentation">
    	...
    	(function($){
          ...
          var data = {
            action: 'wor_dashboard_data',
            start_date: start_date,
            end_date: end_date,
            wor_nonce: '<?php echo wp_create_nonce( 'wor_dashboard_data_nonce' ); ?>'
          }; 
          if(start_date <=0){
